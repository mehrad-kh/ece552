...
class MemoryControl(param_SimObject.SimObject):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
MemoryControl_swigregister = _param_RubyMemoryControl.MemoryControl_swigregister
MemoryControl_swigregister(MemoryControl)

class RubyMemoryControlParams(param_SimObject.SimObjectParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ...
    mem_bus_cycle_multiplier = _swig_property(_param_RubyMemoryControl.RubyMemoryControlParams_mem_bus_cycle_multiplier_get, _param_RubyMemoryControl.RubyMemoryControlParams_mem_bus_cycle_multiplier_set)
