...
class BaseCPUParams(param_MemObject.MemObjectParams):
    ...
    clock = _swig_property(_param_BaseCPU.BaseCPUParams_clock_get, _param_BaseCPU.BaseCPUParams_clock_set)
    ...
    phase = _swig_property(_param_BaseCPU.BaseCPUParams_phase_get, _param_BaseCPU.BaseCPUParams_phase_set)
