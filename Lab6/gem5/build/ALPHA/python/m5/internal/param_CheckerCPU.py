...
class CheckerCPUParams(param_BaseCPU.BaseCPUParams):
    ...
    function_trace = _swig_property(_param_CheckerCPU.CheckerCPUParams_function_trace_get, _param_CheckerCPU.CheckerCPUParams_function_trace_set)
    ...
    function_trace_start = _swig_property(_param_CheckerCPU.CheckerCPUParams_function_trace_start_get, _param_CheckerCPU.CheckerCPUParams_function_trace_start_set)
    def __init__(self): 
