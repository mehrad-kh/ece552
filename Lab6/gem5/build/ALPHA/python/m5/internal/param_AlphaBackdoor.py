...
import param_SimpleDisk
import param_DiskImage
import param_AlphaSystem
...
class AlphaBackdoor(param_BasicPioDevice.BasicPioDevice):
...
class AlphaBackdoorParams(param_BasicPioDevice.BasicPioDeviceParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
