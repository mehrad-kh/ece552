...
private:
    ...
    void as_issueGetS(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr);
    /** \brief Issue a request for read-write access */
    void am_issueGetM(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr);
    /** \brief Issue a PUTS request */
    void bs_issuePUTS(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr);
    /** \brief Issue a PUTM request */
    void bm_issuePUTM(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr);
    /** \brief Send data from cache to requestor */
    void e_sendDataFromCacheToRequestor(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr);
    /** \brief Send data from TBE to requestor */
    void ee_sendDataFromTBEToRequestor(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr);
    /** \brief Send data from cache to directory */
    void de_sendDataFromCacheToDir(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr);
    /** \brief Send data from TBE to directory */
    void dee_sendDataFromTBEToDir(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr);
    /** \brief send Invalidation Acknowledgement to Requestor */
    void fi_sendInvAck(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr);
    ...
    void q_updateAckCount(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr);
