...
// LoadAddress::lda([' Ra = Rb + disp; '],{})
	...
	_destRegIdx[0] = PALMODE ? reg_redir[RA] : RA;
	_srcRegIdx[0] = PALMODE ? reg_redir[RB] : RB;
	_numSrcRegs = 1;
	_numDestRegs = 1;
	_numFPDestRegs = 0;
	_numIntDestRegs = 1;
...
// LoadOrNop::ldt([' Fa = Mem_df; '],{})
	...
	_destRegIdx[0] = FA + FP_Base_DepTag;
	_srcRegIdx[0] = PALMODE ? reg_redir[RB] : RB;
	_numSrcRegs = 1;
	_numDestRegs = 1;
	_numFPDestRegs = 1;
...
// Store::stb([' Mem_ub = Ra<7:0>; '],{})
	...
	_srcRegIdx[0] = PALMODE ? reg_redir[RA] : RA;
	_srcRegIdx[1] = PALMODE ? reg_redir[RB] : RB;
	_numSrcRegs = 2;
	_numDestRegs = 0;
	_numFPDestRegs = 0;
	_numIntDestRegs = 0;
...
// Store::sts([' Mem_ul = t_to_s(Fa_uq); '],{})
	...
	_srcRegIdx[0] = FA + FP_Base_DepTag;
	_srcRegIdx[1] = PALMODE ? reg_redir[RB] : RB;
	_numSrcRegs = 2;
	_numDestRegs = 0;
	_numFPDestRegs = 0;
...
// IntegerOperate::addl([' Rc_sl = Ra_sl + Rb_or_imm_sl; '],{})
	...
	_srcRegIdx[0] = PALMODE ? reg_redir[RA] : RA;
	_srcRegIdx[1] = PALMODE ? reg_redir[RB] : RB;
	_destRegIdx[0] = PALMODE ? reg_redir[RC] : RC;
	_numSrcRegs = 2;
	_numDestRegs = 1;
	_numFPDestRegs = 0;
	_numIntDestRegs = 1;
...
// IntegerOperate::cmovlbs([' Rc = ((Ra & 1) == 1) ? Rb_or_imm : Rc; '],{})
	...
	_srcRegIdx[0] = PALMODE ? reg_redir[RA] : RA;
	_srcRegIdx[1] = PALMODE ? reg_redir[RB] : RB;
	_srcRegIdx[2] = PALMODE ? reg_redir[RC] : RC;
	_destRegIdx[0] = PALMODE ? reg_redir[RC] : RC;
	_numSrcRegs = 3;
	_numDestRegs = 1;
	_numFPDestRegs = 0;
	...
	_srcRegIdx[0] = PALMODE ? reg_redir[RA] : RA;
	_srcRegIdx[1] = PALMODE ? reg_redir[RC] : RC;
	_destRegIdx[0] = PALMODE ? reg_redir[RC] : RC;
	_numSrcRegs = 2;
	_numDestRegs = 1;
	_numFPDestRegs = 0;
...
// BasicOperateWithNopCheck::itofs([' Fc_uq = s_to_t(Ra_ul); ', 'FloatCvtOp'],{})
	...
	_srcRegIdx[0] = PALMODE ? reg_redir[RA] : RA;
	_destRegIdx[0] = FC + FP_Base_DepTag;
	_numSrcRegs = 1;
	_numDestRegs = 1;
	_numFPDestRegs = 1;
	_numIntDestRegs = 0;
...
// FloatingPointOperate::sqrts(['\n                        if (Fb < 0.0)\n                            fault = new ArithmeticFault;\n                        Fc = sqrt(Fb);\n                    ', 'FloatSqrtOp'],{})
	...
	_srcRegIdx[0] = FB + FP_Base_DepTag;
	_destRegIdx[0] = FC + FP_Base_DepTag;
	_numSrcRegs = 1;
	_numDestRegs = 1;
	_numFPDestRegs = 1;
...
// FloatingPointOperate::adds([' Fc = Fa + Fb; '],{})
	...
	_srcRegIdx[0] = FA + FP_Base_DepTag;
	_srcRegIdx[1] = FB + FP_Base_DepTag;
	_destRegIdx[0] = FC + FP_Base_DepTag;
	_numSrcRegs = 2;
	_numDestRegs = 1;
	_numFPDestRegs = 1;
...
// BasicOperateWithNopCheck::fcmoveq([' Fc = (Fa == 0) ? Fb : Fc; '],{})
	...
	_srcRegIdx[0] = FA + FP_Base_DepTag;
	_srcRegIdx[1] = FB + FP_Base_DepTag;
	_srcRegIdx[2] = FC + FP_Base_DepTag;
	_destRegIdx[0] = FC + FP_Base_DepTag;
	_numSrcRegs = 3;
	_numDestRegs = 1;
	_numFPDestRegs = 1;
...
// BasicOperateWithNopCheck::mt_fpcr([' FPCR = Fa_uq; ', 'IsIprAccess'],{})
	...
	_destRegIdx[0] = MISCREG_FPCR + Ctrl_Base_DepTag;
	_srcRegIdx[0] = FA + FP_Base_DepTag;
	_numSrcRegs = 1;
	_numDestRegs = 1;
	_numFPDestRegs = 0;
...
// BasicOperateWithNopCheck::mf_fpcr([' Fa_uq = FPCR; ', 'IsIprAccess'],{})
	...
	_destRegIdx[0] = FA + FP_Base_DepTag;
	_srcRegIdx[0] = MISCREG_FPCR + Ctrl_Base_DepTag;
	_numSrcRegs = 1;
	_numDestRegs = 1;
	_numFPDestRegs = 1;
	_numIntDestRegs = 0;
...
// BasicOperate::rc((['\n                Ra = IntrFlag;\n                IntrFlag = 0;\n            ', 'IsNonSpeculative', 'IsUnverifiable'], {}))
	...
	_destRegIdx[0] = PALMODE ? reg_redir[RA] : RA;
	_srcRegIdx[0] = MISCREG_INTR + Ctrl_Base_DepTag;
	_destRegIdx[1] = MISCREG_INTR + Ctrl_Base_DepTag;
	_numSrcRegs = 1;
	_numDestRegs = 2;
	_numFPDestRegs = 0;
	_numIntDestRegs = 1;
...
// EmulatedCallPal::rduniq([' R0 = Runiq; ', 'IsIprAccess'],{})
	...
	_destRegIdx[0] = 0;
	_srcRegIdx[0] = MISCREG_UNIQ + Ctrl_Base_DepTag;
	_numSrcRegs = 1;
	_numDestRegs = 1;
	_numFPDestRegs = 0;
	_numIntDestRegs = 1;
...
// EmulatedCallPal::wruniq([' Runiq = R16; ', 'IsIprAccess'],{})
	...
	_destRegIdx[0] = MISCREG_UNIQ + Ctrl_Base_DepTag;
	_srcRegIdx[0] = 16;
	_numSrcRegs = 1;
	_numDestRegs = 1;
	_numFPDestRegs = 0;
